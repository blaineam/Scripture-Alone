// 文語訳聖書 — the Japanese literary Bible.
// The ja reader's Bible (docs/localization.md), as iOS's on-demand `bungo` pack. Fetched the
...
val syncPackContents by tasks.registering(Sync::class) {
    from(rootProject.layout.projectDirectory.file("../ScriptureAlone/Resources/Bibles/BUNGO.sqlite"))
