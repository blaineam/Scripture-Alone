// 개역한글 — the Korean Revised Version.
// The ko reader's Bible (docs/localization.md), as iOS's on-demand `krv` pack. Fetched the
...
val syncPackContents by tasks.registering(Sync::class) {
    from(rootProject.layout.projectDirectory.file("../ScriptureAlone/Resources/Bibles/KRV.sqlite"))
