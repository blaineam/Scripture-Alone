// Bíblia Livre.
// The pt-BR reader's Bible (docs/localization.md), as iOS's on-demand `blivre` pack. Fetched the
...
val syncPackContents by tasks.registering(Sync::class) {
    from(rootProject.layout.projectDirectory.file("../ScriptureAlone/Resources/Bibles/BLIVRE.sqlite"))
