// 和合本（新标点）— the Chinese Union Version, simplified.
// The zh-Hans reader's Bible (docs/localization.md), as iOS's on-demand `cuvs` pack. Fetched the
...
val syncPackContents by tasks.registering(Sync::class) {
    from(rootProject.layout.projectDirectory.file("../ScriptureAlone/Resources/Bibles/CUVS.sqlite"))
