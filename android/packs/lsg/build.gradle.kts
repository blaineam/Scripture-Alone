// Louis Segond 1910.
// The fr reader's Bible (docs/localization.md), as iOS's on-demand `lsg` pack. Fetched the
...
val syncPackContents by tasks.registering(Sync::class) {
    from(rootProject.layout.projectDirectory.file("../ScriptureAlone/Resources/Bibles/LSG.sqlite"))
