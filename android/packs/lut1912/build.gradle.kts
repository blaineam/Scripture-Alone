// Lutherbibel 1912.
// The de reader's Bible (docs/localization.md), as iOS's on-demand `lut1912` pack. Fetched the
...
val syncPackContents by tasks.registering(Sync::class) {
    from(rootProject.layout.projectDirectory.file("../ScriptureAlone/Resources/Bibles/LUT1912.sqlite"))
