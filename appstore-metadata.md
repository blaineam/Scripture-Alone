...
## description
Scripture Alone is a free Bible for iPhone, iPad, Mac and Apple Watch, built for one thing: studying God's word without anything in the way. No ads. No trackers. No accounts. Every word is on your device, so it works anywhere in the world, with or without a connection.
...
## review_notes
Scripture Alone is a free, open-source Bible app (AGPL-3.0, https://github.com/blaineam/Scripture-Alone). No account, login or network connection is required for any feature: the Bible texts (ASV, BSB, KJV — all public domain), commentary, cross-references and maps ship inside the app.
